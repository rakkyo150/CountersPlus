...
namespace CountersPlus.ConfigModels
{
    internal class MissedConfigModel : ConfigModel
    {
        ...
        public virtual Color Miss1Color { get; set; } = Color.magenta;
        [UseConverter(typeof(HexColorConverter))]
        [UIValue(nameof(Miss2Color))]
        public virtual Color Miss2Color { get; set; } = Color.blue;
        [UseConverter(typeof(HexColorConverter))]
        [UIValue(nameof(Miss3Color))]
        public virtual Color Miss3Color { get; set; } = Color.green;
        [UseConverter(typeof(HexColorConverter))]
        [UIValue(nameof(Miss4Color))]
        public virtual Color Miss4Color { get; set; } = Color.yellow;
        [UseConverter(typeof(HexColorConverter))]
        [UIValue(nameof(Miss5Color))]
        public virtual Color Miss5Color { get; set; } = new Color(1, 0.5f, 0);
        [UseConverter(typeof(HexColorConverter))]
